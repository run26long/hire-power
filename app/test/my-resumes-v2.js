              ...
              <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-8">
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                    ...
                    {/* Next Step Embedded Here */}
                    <div className="bg-purple-50 border-l-4 border-purple-600 p-3 mb-5 rounded-r">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-xs font-semibold text-purple-600 uppercase mb-0.5">NEXT STEP</div>
                          <div className="text-sm font-semibold text-gray-900">Continue building your core resume</div>
                        </div>
                        <button
                          onClick={() => router.push(`/resume/${data.coreResume.id}`)}
                          className="bg-purple-600 text-white px-4 py-1.5 rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm"
                        >
                          Open →
                        </button>
                      </div>
                    ...
                    <h2 className="text-base font-semibold text-gray-900 mb-4">Core Resume</h2>
