      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-h-0 md:max-w-7xl md:mx-auto md:w-full">
          ...
          <div className={`flex flex-col overflow-hidden min-h-0 md:flex-[3] ${mobilePanel === 'analysis' ? 'flex' : 'hidden'} md:flex`}>
            ...
            {/* Practice alone stretches this to the full column height. Its panel
                ...
                their content on purpose. Scrolling stays on everywhere: clipping
                here cut the shadow off the bottom card, and the question list is
                a fixed height, so this only ever scrolls on a short viewport. */}
