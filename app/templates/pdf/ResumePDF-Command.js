      ...
      <Page size="LETTER" style={{ fontFamily: f, fontSize: base, lineHeight: 1.3, color: '#1a1a1a', backgroundColor: '#ffffff' }} wrap={false}>
        ...
        <View style={{ paddingLeft: Math.round(52*sp), paddingRight: Math.round(52*sp), paddingTop: Math.round(16*sp), paddingBottom: Math.round(36*sp) }}>
          ...
          {resumeData.experience?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Experience</Text>
          ...
          {resumeData.education?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Education</Text>
          ...
          {Object.keys(skills).length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Skills</Text>
          ...
          {resumeData.certifications?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Certifications</Text>
          ...
          {resumeData.volunteer?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Volunteer Experience</Text>
          ...
          {resumeData.projects?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Projects</Text>
          ...
          {resumeData.additionalInfo?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Additional Information</Text>
          ...
          {resumeData.languages?.length > 0 && (
            <View style={{ marginTop: Math.round(14*sp) }}>
              <Text style={{ fontFamily: f, fontSize: base+1, fontWeight: 'bold', textTransform: 'uppercase', color: color, borderBottomWidth: 2, borderBottomColor: color, paddingBottom: Math.round(2*sp), marginBottom: Math.round(5*sp) }}>Languages</Text>
