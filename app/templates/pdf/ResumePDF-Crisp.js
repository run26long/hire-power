                ...
                <View key="education" style={{ marginTop: Math.round(14*sp) }}>
                  <View wrap={false}>
                    ...
                    <View style={{ marginBottom: restEd.length > 0 ? Math.round(10*sp) : 0 }}>
                      ...
                      <Text style={{ fontFamily: f, fontSize: base, fontStyle: 'italic', color: '#555555' }}>{[firstEd.degree, firstEd.field].filter(Boolean).join(', ')}</Text>
                  ...
                  {restEd.map((ed, i) => (
                    <View key={i+1} wrap={false} style={{ marginBottom: i < restEd.length - 1 ? Math.round(10*sp) : 0 }}>
                      ...
                      <Text style={{ fontFamily: f, fontSize: base, fontStyle: 'italic', color: '#555555' }}>{[ed.degree, ed.field].filter(Boolean).join(', ')}</Text>
