...
export const ACCENTS = [
  ...
  { id: 'emerald',    label: 'Emerald',           stored: '#18745F', light: '#18745F', dark: '#72C8AE' },
  { id: 'cobalt',     label: 'Cobalt',            stored: '#3559C7', light: '#3559C7', dark: '#8EA6FF' },
  { id: 'espresso',   label: 'Espresso',          stored: '#6B4A3B', light: '#6B4A3B', dark: '#C89D87' },
  { id: 'sage',       label: 'Sage',              stored: '#78927A', light: '#526B55', dark: '#A9C4A8' },
  { id: 'navy',       label: 'Navy',              stored: '#23405F', light: '#31577A', dark: '#86A9CE' },
  { id: 'crimson',    label: 'Crimson',           stored: '#A63D4D', light: '#A63D4D', dark: '#F08A98' },
  { id: 'slate',      label: 'Slate',             stored: '#5F6B7A', light: '#5F6B7A', dark: '#ABB5C3' },
  { id: 'monochrome', label: 'Monochrome',        stored: '#3D3D43', light: '#4B4B52', dark: '#C9C9D0' },
]
